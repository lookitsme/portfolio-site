...
export const aboutContent = {
  intro: ["I'm Able! (he/him)", 'I build web experiences'],
  mission: [
  ...
  testimonials: [
    {
      quote:
        "Able's kickass work is complemented by his infectious energy and passion for creating original, exciting work. He is a true creative partner––always bringing new ideas to the table.",
      shortName: 'Stef',
      name: 'Stephanie Jung',
      headshot: stefImage,
    ...
    {
      quote:
        "Able's collaborative mindset and aptitude to explore ideas well beyond the minimum viable product make him an invaluable partner.",
      name: 'JP Ramirez',
      shortName: 'JP',
      title: [
    ...
    {
      quote:
        "Able's building enables award-winning projects––including FWA Site Of The Day, Webby, 2x Awwwards Honorable Mention, CSSDA Special Kudos, CSSDA Best UI/UX/Innovation, 4x STA100, Type Director's Club, Webby For Good... & more.",
